// 石板路：从 cottage 门口延伸到地块中央区域。
// 8 块 boxGeometry（0.4×0.04×0.4）拼接，颜色 0xb8a888，微随机旋转 ±0.1 rad。
// 路径坐标基于 cottage 门口，相对偏移在 STONES 里。组件级 group 用 COTTAGE_POS 锚定。
 ...
 * 用 group position=COTTAGE_POS 锚定；内部石头用相对偏移。
 */
